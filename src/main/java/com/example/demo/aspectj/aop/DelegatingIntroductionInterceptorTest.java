...
public class DelegatingIntroductionInterceptorTest extends DelegatingIntroductionInterceptor implements ITest {
    @Override
    public void test() {
    ...
    public static void main(String[] args) {
        ...
        Advice advice = new DelegatingIntroductionInterceptorTest();
